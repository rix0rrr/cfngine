export namespace schema {
  ...
  export type FnCidr = { 'Fn::Cidr': [string | FnSelect | Ref, number, number] };
  export type FnFindInMap = { 'Fn::FindInMap': [CfnValue<string>, CfnValue<string>, CfnValue<string>] };
  ...
  export type FnJoin = { 'Fn::Join': [string, CfnValue<Array<CfnValue<string>>>] };
